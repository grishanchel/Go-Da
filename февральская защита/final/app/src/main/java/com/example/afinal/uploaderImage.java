...
public class uploaderImage {
    ...
    public String uploadFileAvatar() {
        if (filePath != null) {
            ...
            return "https://firebasestorage.googleapis.com/v0/b/mostfi.appspot.com/o" + "/images%2Favatars%2F" + ref.getPath().substring(16) + "?alt=media";
        }
        else {
            return null;
        }
    ...
    public String uploadDishPicture() {
        if (filePath != null) {
            ...
            return "https://firebasestorage.googleapis.com/v0/b/mostfi.appspot.com/o" + "/images%2Fpictures%2F" + ref.getPath().substring(17) + "?alt=media";
        }
        else {
            return null;
        }
